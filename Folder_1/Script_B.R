...
##### R script to compute GO-2-Substrates rank of proteins in whole proteome mode #####
##### NOTE - script only differs from SCRIPT A in call to "fimo_bio.csv" vs "fimo_sensitivity_1.csv"
...
# import cutsites
cutsites = read.csv(file="fimo_bio.csv", header=TRUE)
...
write.csv(cutsites_subset_unique_GO2Substrates_rank, "Supplementary_Table_whole_proteome_mode.csv")
